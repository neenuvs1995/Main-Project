...
fn = fullfile(pn,fn);
% Reading image
im1 = readImage_level1(fn);
im2 = readImage_level2(fn);
im3 = readImage_level3(fn);

% Finding probabilities
p1 = activations(net_L1,im1,'softmaxL','OutputAs','rows');
p2 = activations(net_L2,im2,'softmax_L2','OutputAs','rows');
p3 = activations(net_L3,im3,'softmax_L3','OutputAs','rows');
...
my_prediction = string(labels_unique(ind));
